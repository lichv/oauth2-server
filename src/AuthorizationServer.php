...
namespace Lichv\OAuth2\Server;

use Defuse\Crypto\Key;
use League\Event\EmitterAwareInterface;
use League\Event\EmitterAwareTrait;
use Lichv\OAuth2\Server\Exception\OAuthServerException;
use Lichv\OAuth2\Server\Grant\GrantTypeInterface;
...
use Lichv\OAuth2\Server\ResponseTypes\AbstractResponseType;
use Lichv\OAuth2\Server\ResponseTypes\BearerTokenResponse;
